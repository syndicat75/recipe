 ...
 * @description 개별 레시피 카드 컴포넌트, 카테고리 뱃지, 재료 프리뷰, 즐겨찾기 토글 및 상세 모달 열기 지원
 */

import React from 'react';
import { Bookmark, Clock, Flame, ArrowRight, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <article className="h-full">
      <div
        ...
        className="group relative flex h-full w-full flex-col justify-between rounded-[1.75rem] border border-orange-100/90 bg-white p-5 text-left shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-orange-300 hover:shadow-xl hover:shadow-orange-900/5 sm:p-6 cursor-pointer focus:outline-none focus:ring-2 focus:ring-orange-400"
      >
        ...
        <div>
          ...
          {/* Recipe Name */}
          <h3 className="mt-4 font-soft text-lg font-black leading-snug text-stone-900 transition group-hover:text-orange-600 sm:text-xl">
            {recipe.name}
          </h3>
